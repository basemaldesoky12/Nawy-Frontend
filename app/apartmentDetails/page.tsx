...
<div className="relative overflow-x-auto flex justify-between ">
    ...
    <div className='w-1/2 flex justify-center'>
        ...
        <div className="mb-5">
            <input placeholder='Your name' type="text" id="large-input" className="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-xs focus:outline-blue-500"/>
        </div>
        <div className="mb-5">
            <input placeholder='Your email' type="text" id="base-input" className="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-xs focus:outline-blue-500"/>
        </div>
        <div>
            <input placeholder='Your message' type="text" id="small-input" className="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-xs focus:outline-blue-500"/>
        </div>
